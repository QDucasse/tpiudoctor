...
################################################################
# This is a generated script based on design: tpiuled
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: zynq_ps_pl, and set properties
  set zynq_ps_pl [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 zynq_ps_pl ]
...
\
    ...
    CONFIG.PSU__EXPAND__CORESIGHT {1} \
...
\
  ...
  # Create instance: tpiu_sync_detect_0, and set properties
  set block_name tpiu_sync_detect
  set block_cell_name tpiu_sync_detect_0
  if { [catch {set tpiu_sync_detect_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tpiu_sync_detect_0 eq "" } {
  ...
  connect_bd_net -net c_counter_binary_1_Q  [get_bd_pins c_counter_binary_1/Q] \
  ...
  [get_bd_ports Dout_1]
  connect_bd_net -net zynq_ps_pl_pl_clk0  [get_bd_pins zynq_ps_pl/pl_clk0] \
  [get_bd_pins zynq_ps_pl/pl_ps_trace_clk]
  connect_bd_net -net zynq_ps_pl_pl_resetn0  [get_bd_pins zynq_ps_pl/pl_resetn0] \
  [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net zynq_ps_pl_ps_pl_tracedata  [get_bd_pins zynq_ps_pl/ps_pl_tracedata] \
  [get_bd_pins tpiu_sync_detect_0/IN_DATA]
  connect_bd_net -net zynq_ps_pl_trace_clk_out  [get_bd_pins zynq_ps_pl/trace_clk_out] \
  [get_bd_pins c_counter_binary_0/CLK] \
  [get_bd_pins c_counter_binary_1/CLK] \
  [get_bd_pins tpiu_sync_detect_0/ACLK] \
