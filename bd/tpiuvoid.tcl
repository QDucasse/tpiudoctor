...
\
    ...
    CONFIG.PSU__CRF_APB__DBG_TRACE_CTRL__ACT_FREQMHZ {100.000000} \
...
\
  ...
  # Create instance: tpiu_blackhole, and set properties
  set block_name trace_blackhole
  set block_cell_name tpiu_blackhole
  if { [catch {set tpiu_blackhole [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tpiu_blackhole eq "" } {
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_ps_pl_tracectl  [get_bd_pins zynq_ps_pl/ps_pl_tracectl] \
  [get_bd_pins tpiu_blackhole/trace_ctl]
  connect_bd_net -net zynq_ultra_ps_e_0_ps_pl_tracedata  [get_bd_pins zynq_ps_pl/ps_pl_tracedata] \
  [get_bd_pins tpiu_blackhole/trace_data]
  connect_bd_net -net zynq_ultra_ps_e_0_trace_clk_out  [get_bd_pins zynq_ps_pl/trace_clk_out] \
  [get_bd_pins tpiu_blackhole/trace_clk]
