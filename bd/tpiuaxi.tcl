...
proc create_root_design { parentCell } {
  ...
  # Create instance: zynq_ultra_ps_pl, and set properties
  set zynq_ultra_ps_pl [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 zynq_ultra_ps_pl ]
...
\
  ...
  if { [catch {set tpiu_to_axi [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tpiu_to_axi eq "" } {
