...
################################################################
# This is a generated script based on design: tpiuaxi
#
...
\
  ...
  # Create instance: tpiu_to_axi_0, and set properties
  set block_name tpiu_to_axi
  set block_cell_name tpiu_to_axi_0
  if { [catch {set tpiu_to_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $tpiu_to_axi_0 eq "" } {
  ...
  # Create instance: proc_sys_reset_trace, and set properties
  set proc_sys_reset_trace [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_trace ]
  ...
  connect_bd_intf_net -intf_net tpiu_to_axi_0_interface_axis [get_bd_intf_pins tpiu_to_axi_0/interface_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  [get_bd_pins zynq_ultra_ps_e_0/pl_ps_trace_clk] \
  [get_bd_pins proc_sys_reset_trace/slowest_sync_clk] \
  [get_bd_pins tpiu_to_axi_0/ACLK] \
  [get_bd_pins axis_data_fifo_0/s_axis_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn  [get_bd_pins proc_sys_reset_trace/peripheral_aresetn] \
  [get_bd_pins tpiu_to_axi_0/ARESETN] \
  [get_bd_pins axis_data_fifo_0/s_axis_aresetn] \
  [get_bd_pins clk_wiz_0/resetn]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn  [get_bd_pins proc_sys_reset_axi/peripheral_aresetn] \
  ...
  [get_bd_pins proc_sys_reset_trace/ext_reset_in]
  connect_bd_net -net zynq_ultra_ps_e_0_ps_pl_tracedata  [get_bd_pins zynq_ultra_ps_e_0/ps_pl_tracedata] \
  [get_bd_pins tpiu_to_axi_0/IN_DATA]
  connect_bd_net -net zynq_ultra_ps_e_0_trace_clk_out  [get_bd_pins zynq_ultra_ps_e_0/trace_clk_out] \
